...
Part of the [FLASH monorepo](https://github.com/vijayee/FLASH) — a Dart/Flutter twin (`flash_webrtc`) speaks the same wire protocol, so JS and Flutter peers interoperate.
